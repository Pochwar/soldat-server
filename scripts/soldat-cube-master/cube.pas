...
//     Specifies the maximum number of team-changing trigger uses (e.g. !alpha, !a). Only affects the built-in triggers,
...
type tpl = record
	...
	triggers:       // number of team-changing trigger uses (!alpha, !a, etc.)
		byte;
...
begin
	...
	case lowercase(text) of
		...
		'!bravo', '!blu', '!blue', '!b', '!joinb', '!join2': begin
